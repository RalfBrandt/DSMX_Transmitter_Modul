...
#define CLOCK_DIV_VC3          0x16    // VC3 clock divider
#define CLOCK_DIV_VC3_MASK     0xff    // VC3 clock divider mask
#define CLOCK_DIV_VC3_JUST     0x16    // VC3 clock divider justified
...
#define PORT_0_DRIVE_1         0x41    //Port 0 drive mode 1 register (PRT0DM1)
...
#define PORT_0_INTCTRL_0       0x40    //Port 0 interrupt control 0 register (PRT0IC0)
#define PORT_0_INTCTRL_1       0x40    //Port 0 interrupt control 1 register (PRT0IC1)
#define PORT_1_GLOBAL_SELECT   0x2     //Port 1 global select register (PRT1GS)
#define PORT_1_DRIVE_0         0xa9    //Port 1 drive mode 0 register (PRT1DM0)
#define PORT_1_DRIVE_1         0x56    //Port 1 drive mode 1 register (PRT1DM1)
#define PORT_1_DRIVE_2         0x14    //Port 1 drive mode 2 register (PRT1DM2)
