...
;  Global Symbols
;-----------------------------------------------
export  Counter8_2_EnableInt
export _Counter8_2_EnableInt
export  Counter8_2_DisableInt
export _Counter8_2_DisableInt
export  Counter8_2_Start
export _Counter8_2_Start
export  Counter8_2_Stop
export _Counter8_2_Stop
export  Counter8_2_WritePeriod
export _Counter8_2_WritePeriod
export  Counter8_2_WriteCompareValue
export _Counter8_2_WriteCompareValue
export  Counter8_2_bReadCompareValue
export _Counter8_2_bReadCompareValue
export  Counter8_2_bReadCounter
export _Counter8_2_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bCounter8_2_ReadCompareValue  ; deprecated
export _bCounter8_2_ReadCompareValue  ; deprecated
export  bCounter8_2_ReadCounter       ; deprecated
export _bCounter8_2_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_2_EnableInt
;
;  DESCRIPTION:
...
_Counter8_2_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Counter8_2_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_2_DisableInt
;
;  DESCRIPTION:
...
_Counter8_2_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Counter8_2_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_2_Start
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_2_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 Counter8_2_WritePeriod:
_Counter8_2_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Counter8_2_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_2_WriteCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 Counter8_2_WriteCompareValue:
_Counter8_2_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Counter8_2_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_2_bReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 Counter8_2_bReadCompareValue:
_Counter8_2_bReadCompareValue:
 bCounter8_2_ReadCompareValue:                   ; this name deprecated
_bCounter8_2_ReadCompareValue:                   ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Counter8_2_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_2_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 Counter8_2_bReadCounter:
_Counter8_2_bReadCounter:
 bCounter8_2_ReadCounter:                        ; this name deprecated
_bCounter8_2_ReadCounter:                        ; this name deprecated
   ...
   mov   A, reg[Counter8_2_COMPARE_REG]          ; Save the Compare register on the stack
   push  A                                       ;
   mov   A, reg[Counter8_2_CONTROL_REG]          ; Save CR0 (running or stopped state)
   push  A                                       ;
   Counter8_2_Stop_M                             ; Disable (stop) the Counter if running
   M8C_SetBank1                                  ;
   mov   A, reg[Counter8_2_INPUT_REG]            ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[Counter8_2_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[Counter8_2_COUNTER_REG]          ; DR2 <- DR0
   mov   A, reg[Counter8_2_COMPARE_REG]          ; Stash the Count on the stack
   ...
   mov   reg[Counter8_2_INPUT_REG], A            ;
   M8C_SetBank0                                  ;   then re-enable (start) the counter
   mov   A, [X+bOrigControlReg]                  ;     if it was running when
   mov   reg[Counter8_2_CONTROL_REG], A          ;     this function was first called
