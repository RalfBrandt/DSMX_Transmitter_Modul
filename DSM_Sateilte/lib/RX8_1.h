...
//*****************************************************************************
//*****************************************************************************
#ifndef RX8_1_INCLUDE
#define RX8_1_INCLUDE

// include the global header file
#include <m8c.h>

#define RX8_1_RXBUF_ENABLE 0
...
#define  RX8_1_RX_ERROR            0xE0
#define  RX8_1_RX_NO_ERROR         0xE0         // This symbol is deprecated and will removed in the future
...
//-------------------------------------------------
#pragma ioport  RX8_1_CONTROL_REG:  0x02f                  // Control register
BYTE            RX8_1_CONTROL_REG;
#pragma ioport  RX8_1_RX_SHIFT_REG: 0x02c                  // RX Shift Register register
BYTE            RX8_1_RX_SHIFT_REG;
#pragma ioport  RX8_1_RX_BUFFER_REG:    0x02e              // RX Buffer Register
BYTE            RX8_1_RX_BUFFER_REG;
#pragma ioport  RX8_1_FUNC_REG: 0x12c                      // Function register
BYTE            RX8_1_FUNC_REG;
#pragma ioport  RX8_1_INPUT_REG:    0x12d                  // Input register
BYTE            RX8_1_INPUT_REG;
#pragma ioport  RX8_1_OUTPUT_REG:   0x12e                  // Output register
