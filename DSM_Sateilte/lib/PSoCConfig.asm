...
export LoadConfig_dsm_sateilte
export _LoadConfig_dsm_sateilte
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_dsm_sateilte
	lcall	LoadConfigTBL_dsm_sateilte_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration dsm_sateilte
;
;    Load configuration registers for dsm_sateilte.
...
;               CUR_PP
;
_LoadConfig_dsm_sateilte:
 LoadConfig_dsm_sateilte:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_dsm_sateilte_Bank0
    mov     X, <LoadConfigTBL_dsm_sateilte_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_dsm_sateilte_Bank1
    mov     X, <LoadConfigTBL_dsm_sateilte_Bank1
